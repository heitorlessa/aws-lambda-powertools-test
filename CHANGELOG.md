...
* **deps-dev:** bump coverage from 7.2.4 to 7.2.5 ([#3](https://github.com/awslabs/aws-lambda-powertools-python/issues/3))
...
* **deps:** bump codecov/codecov-action from 3.1.3 to 3.1.4 ([#81](https://github.com/awslabs/aws-lambda-powertools-python/issues/81))
...
* **deps:** bump dependabot/fetch-metadata from 1.4.0 to 1.5.0 ([#133](https://github.com/awslabs/aws-lambda-powertools-python/issues/133))
* **deps-dev:** bump mypy from 1.2.0 to 1.3.0 ([#111](https://github.com/awslabs/aws-lambda-powertools-python/issues/111))
...
[Unreleased]: https://github.com/awslabs/aws-lambda-powertools-python/compare/v2.16.5...HEAD
[v2.16.5]: https://github.com/awslabs/aws-lambda-powertools-python/compare/v2.16.4...v2.16.5
[v2.16.4]: https://github.com/awslabs/aws-lambda-powertools-python/compare/v2.16.3...v2.16.4
[v2.16.3]: https://github.com/awslabs/aws-lambda-powertools-python/compare/v2.16.2...v2.16.3
